/**
 * ObjectUploader — a button that opens an Uppy dashboard modal for uploading
 * files directly to object storage via per-file presigned (PUT) URLs.
 * The caller supplies onGetUploadParameters to mint URLs and an optional
 * onComplete to run post-upload work (e.g. setting ACLs / updating server state).
 */
